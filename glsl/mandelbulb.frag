...
// https://github.com/niavok/glsl-factory/blob/master/shaders/mandelbulb/f.glsl
...
void main(void)
{
    ...
    float fov = 1.0;
    float r = 1.4+0.2*cos(6.28318*u_time/20.0);
    vec3 campos = vec3( r*sin(6.28318*u_time/20.0), 0.3-0.4*sin(6.28318*u_time/20.0), r*cos(6.28318*u_time/20.0) );
